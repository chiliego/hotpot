...
public class HotPotAgent_orig {
    private static Logger LOGGER = LogManager.getLogger(HotPotAgent_orig.class);
    ...
    public static void agentmain(String agentArgs, Instrumentation inst) {
        ...
        try {
            initDirs(hotpotHomeFolder);
        } catch (IOException e) {
            e.printStackTrace();
            return;
        }

        Path classPathconfigPath = getClassPathConPath(hotpotHomeFolder);
        Path cmdPath = getCmdPath(hotpotHomeFolder);
    ...
    private static Path getCmdPath(String hotpotHomeFolder) {
        return getHomeFolder(hotpotHomeFolder).resolve("cmd");
    }

    private static Path getClassPathConPath(String hotpotHomeFolder) {
        return getHomeFolder(hotpotHomeFolder).resolve("conf");
    }
    ...
    private static void initDirs(String hotpotHomeFolder) throws IOException {
